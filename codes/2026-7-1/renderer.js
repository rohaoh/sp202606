...
(async () => {
  ...
  function localSimulate(mass, area, cd) {
    ...
    while (h>0 && t<7200) {
      ...
      // Total relative velocity drag — matches 3-D physics (per-axis was overcounting)
      ...
      // [F16] aerodynamic heating (Mach-based) — use total speed, not just vertical
  ...
  btnRun.addEventListener('click',async()=>{
    ...
    if(features.multiobj){
      moObjects.forEach(o=>{ o.result=localSimulate(o.mass,o.area,o.cd); o._cs={c:0}; });
    }
