...
contextBridge.exposeInMainWorld('appBridge', {
    ...
    onFilePicked:    (cb)   => ipcRenderer.on('menu:file-picked', (_e, p) => cb(p)),  // 네이티브 메뉴 업로드
    ...
    openExternal:    (url)  => ipcRenderer.send('shell:open-external', url),  // 클라우드 결과 링크를 기본 브라우저로 열기
});
